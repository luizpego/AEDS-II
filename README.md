...
Este programa implementa uma **Lista Sequencial Estática**, uma estrutura de dados linear que armazena elementos em um vetor de inteiros. Os elementos ficam armazenados em posições consecutivas.
